...
|:----------------------------------------------------|:-------------------------------------------------------------------|
| OTbase Inventory > Create CVEs                 | Creates CVE records and links them with the OTbase Inventory asset |
| OTbase Inventory > Link ICS Advisory to Assets | Links ICS Advisory to assets                                       |
